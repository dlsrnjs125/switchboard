...
- Reconnect storm: 100/500/1000 already-connected logical transports observe a Distribution stop, schedule exponential backoff with jitter, reconnect after restart, load the new authoritative full Snapshot, and return accepted ACKs. Recovery percentiles, admission rejection, and PostgreSQL authentication/bootstrap query amplification are retained separately from initial connection capacity.
